...
const VirtualUpcomingService = async ({
  queryPageIndex,
  queryPageSize,
  queryPageFilter,
  queryPageSortBy,
  ...
  const response = getQueryResponse({ Parse, queryPageFilter, queryPageSortBy, queryPageSize, queryPageIndex, queryTable: "VirtualCall", status: "upcoming" })
  try {
...
export default VirtualUpcomingService
