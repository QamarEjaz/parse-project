...
const VirtualActiveService = async ({
  queryPageIndex,
  queryPageSize,
  queryPageFilter,
  queryPageSortBy,
  ...
  const response = getQueryResponse({ Parse, queryPageFilter, queryPageSortBy, queryPageSize, queryPageIndex, queryTable: "VirtualCall", status: "active" })
  try {
...
export default VirtualActiveService
